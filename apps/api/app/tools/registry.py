...
TOOL_REGISTRY = {
    ...
    for item in [
        ...
        ToolDefinition(
            ...
            "Fetch sourced regional crop, dairy, livestock, and diversified-use assumptions",
            {"type": "object", "required": ["latitude", "longitude"]},
            {"type": "object"},
            60,
            1,
        ...
        ToolDefinition(
            "listing.search",
            "Search a configured and permitted rural listing provider",
            {"type": "object", "required": ["latitude", "longitude", "radius_miles"]},
            {"type": "array"},
            45,
            1,
            "provider-specific",
        ...
        ToolDefinition(
            "hazard.get_context",
            "Fetch hazard context relevant to the current activity",
            {"type": "object", "required": ["latitude", "longitude", "hazards"]},
            {"type": "object"},
            45,
            1,
            "provider-specific",
        ...
        ToolDefinition(
            "geo.validate_boundary",
            "Validate geometry and compare its area with claimed acreage",
        ...
        ToolDefinition(
            ...
            "Execute a registered deterministic derived signal",
        ...
        ToolDefinition(
            ...
            "Explain material advantages, disadvantages, and unknowns across options",
            {"type": "object", "required": ["option_ids"]},
            {"type": "object"},
            10,
            0,
            "deterministic",
